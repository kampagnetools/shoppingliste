          ...
          <form @submit.prevent="handleSubmit" class="space-y-5">
            <div>
              ...
              <input
                ...
                required
                autocomplete="email"
                class="w-full px-4 py-2.5 bg-slate-50 border border-slate-200 rounded-lg focus:ring-4 focus:ring-[#002060]/10 focus:border-[#002060] outline-none transition-all placeholder:text-slate-400"
            ...
            <div v-if="errorMsg" class="p-3 rounded-lg bg-red-50 border border-red-100 text-xs text-red-700 font-medium animate-in fade-in slide-in-from-top-1">
              {{ errorMsg }}
            </div>
            ...
            <button 
              type="submit" 
              :disabled="loading" 
              class="w-full bg-[#002060] hover:bg-[#001845] text-white font-bold py-3 rounded-lg shadow-lg shadow-[#002060]/10 transition-all active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
